...
--rollback DROP TRIGGER IF EXISTS configuration_audit ON template_service.configuration;
--rollback DROP TRIGGER IF EXISTS template_config_audit ON template_service.template_config;
--rollback DROP TABLE template_service.template_engine_mapping;
--rollback DROP TABLE template_service.rendering_engine;
--rollback DROP TABLE template_service.template_config;
--rollback DROP TABLE template_service.configuration;