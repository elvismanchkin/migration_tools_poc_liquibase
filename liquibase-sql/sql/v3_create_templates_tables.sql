...
--rollback DROP TRIGGER IF EXISTS template_audit ON template_service.template;
--rollback DROP TRIGGER IF EXISTS template_version_audit ON template_service.template_version;
--rollback DROP TABLE template_service.template_variable;
--rollback DROP TABLE template_service.template_version;
--rollback DROP TABLE template_service.template;
--rollback DROP TABLE template_service.template_category;